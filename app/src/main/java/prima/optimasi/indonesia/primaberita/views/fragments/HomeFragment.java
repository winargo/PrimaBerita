...
import prima.optimasi.indonesia.primaberita.views.custom.TouchyWebView;

/**
 * Created by Constant-Lab LLP on 20-04-2017.
 */

public class HomeFragment extends BaseFragment implements RecentPostsContract.RecentPostsView, PostsAdapter.InteractionListener {
    ...
    private void initView(View view) {
        ...
        touchwebview = view.findViewById(R.id.touchweb);

        touchwebview.getSettings().setLoadWithOverviewMode(true);
        touchwebview.getSettings().setUseWideViewPort(true);
