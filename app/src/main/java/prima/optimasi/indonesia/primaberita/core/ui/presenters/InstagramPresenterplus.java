...
public class InstagramPresenterplus extends BasePresenter<InstagramContract.InstagramView> implements InstagramContract.ViewActions {


    private final DataManager mDataManager;

    public InstagramPresenterplus(DataManager mDataManager) {
    ...
    public void onInitialInstagramRequested(String pageId) {
        ...
        mDataManager.getInstagramPosts(BASE_URL_INSTAGRAM, Config.INSTAGRAM_TOKEN_PLUS, new RemoteCallback<ResponseBody>() {
            @Override
